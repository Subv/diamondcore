...
int WorldSocket::HandleAuthSession (WorldPacket& recvPacket)
{
    ...
    // Get the account information from the LogonServer database
    ...
    ///- Re-check ip locking (same check as in LogonServer).
    ...
    // Re-check account ban (same check as in LogonServer)
