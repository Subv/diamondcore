...
bool Spell::FillCustomTargetMap(uint32 i, UnitList &targetUnitMap)
{
    ...
    switch (m_spellInfo->Id)
    {
        case 46584: // Raise Dead
            {
            WorldObject* result = FindCorpseUsing <Diamond::RaiseDeadObjectCheck>  ();
...
template WorldObject* Spell::FindCorpseUsing<Diamond::RaiseDeadObjectCheck>();
...
void Spell::SetTargetMap(SpellEffectIndex effIndex, uint32 targetMode, UnitList& targetUnitMap)
{
    ...
    switch(targetMode)
    {
        ...
        case TARGET_RANDOM_NEARBY_DEST:
        {
            ...
            // and no unitTarget (e.g. summon effects). As DiamondCore always needs a unitTarget we add just the caster here.
