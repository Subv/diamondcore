...
void OPvPCapturePointTF::ChangeState()
{
    ...
    if ( m_OldState == OBJECTIVESTATE_ALLIANCE )
    {
        ...
        sWorld.SendZoneText(OutdoorPvPTFBuffZones[0],sObjectMgr.GetStringForDBCLocale(LANG_OPVP_TF_LOOSE_A));
    }
    ...
    else if ( m_OldState == OBJECTIVESTATE_HORDE )
    {
        ...
        sWorld.SendZoneText(OutdoorPvPTFBuffZones[0],sObjectMgr.GetStringForDBCLocale(LANG_OPVP_TF_LOOSE_H));
    }
