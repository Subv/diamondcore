...
#ifndef DIAMOND_CHATLOG_H
#define DIAMOND_CHATLOG_H
...
class ChatLog : public Diamond::Singleton<ChatLog, Diamond::ClassLevelLockable<ChatLog, /*ZThread::Mutex*/ACE_Thread_Mutex> >
{
    public:
        ChatLog();
        ~ChatLog();
...
#define sChatLog Diamond::Singleton<ChatLog>::Instance()
#endif
