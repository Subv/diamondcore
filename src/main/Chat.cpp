...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "strings",                     SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadStringCommand,                  "", NULL },
...
std::string ChatHandler::PrepareStringNpcOrGoSpawnInformation(uint32 guid)
{
    ...
    if (uint16 pool_id = sPoolMgr.IsPartOfAPool<T>(guid))
    {
        ...
        {
            char buffer[100];
            const char* format = GetString(LANG_NPC_GO_INFO_POOL_EVENT_STRING);
        ...
        {
            char buffer[100];
            const char* format = GetString(LANG_NPC_GO_INFO_POOL_STRING);
    ...
    {
        char buffer[100];
        const char* format = GetString(LANG_NPC_GO_INFO_EVENT_STRING);
