...
struct boss_novosAI : public ScriptedAI
{
...
struct crystal_handlerAI : public ScriptedAI
{
...
struct crystal_channelAI : public ScriptedAI
{
...
struct risen_shadowcasterAI : public ScriptedAI
{
