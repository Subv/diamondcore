...
struct iron_councilAI : public ScriptedAI
{
...
/**************************************
            Steelbreakeer
**************************************/
struct boss_steelbreakerAI : public iron_councilAI
{
...
/************************************
        Stormcaller Brundir
************************************/
struct boss_brundirAI : public iron_councilAI
{
...
/************************************
        Runemaster Molgeim
************************************/
struct boss_molgeimAI : public iron_councilAI
{
