...
struct boss_proffesor_putricideAI : public BSWScriptedAI
{
...
struct mob_icc_gas_cloudAI : public BSWScriptedAI
{
...
struct mob_icc_volatile_oozeAI : public BSWScriptedAI
{
