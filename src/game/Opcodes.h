...
enum Opcodes
{
    ...
    SMSG_CHAR_DELETE                                = 0x8012,    // 32786 - 4.0.0.12479
    ...
    SMSG_GROUP_DECLINE                              = 0x164,      // 100   - 4.0.0.12319
    ...
    SMSG_GUILD_ROSTER                               = 0x4202,    // 33356 - 4.0.0.12319
    ...
    SMSG_ITEM_COOLDOWN                              = 0x22E,    // 38002 - 4.0.0.12319
    ...
    MSG_MOVE_START_FORWARD                          = 0xD03C,    // 34318 - 4.0.0.12319
    MSG_MOVE_START_BACKWARD                         = 0x861C,    // 34322 - 4.0.0.12319
    MSG_MOVE_STOP                                   = 0x1208,    // 37500 - 4.0.0.12319
    MSG_MOVE_START_STRAFE_LEFT                      = 0xC264,    // 33364 - 4.0.0.12319
    MSG_MOVE_START_STRAFE_RIGHT                     = 0x9028,    // 33394 - 4.0.0.12319
    MSG_MOVE_STOP_STRAFE                            = 0x123C,    // 17470 - 4.0.0.12319
    MSG_MOVE_JUMP                                   = 0x9F6A,    // 17458 - 4.0.0.12319
    MSG_MOVE_START_TURN_LEFT                        = 0x1618,    // 16908 - 4.0.0.12319
    MSG_MOVE_START_TURN_RIGHT                       = 0x4420,     // 1616  - 4.0.0.12319
    MSG_MOVE_STOP_TURN                              = 0x216,    // 33828 - 4.0.0.12319
    MSG_MOVE_START_PITCH_UP                         = 0x5010,    // 16402 - 4.0.0.12319
    MSG_MOVE_START_PITCH_DOWN                       = 0x9472,    // 49682 - 4.0.0.12319
    MSG_MOVE_STOP_PITCH                             = 0x500A,    // 50724 - 4.0.0.12319
    MSG_MOVE_SET_RUN_MODE                           = 0x8066,    // 54876 - 4.0.0.12319
    MSG_MOVE_SET_WALK_MODE                          = 0x9436,    // 17506 - 4.0.0.12319
    MSG_MOVE_TOGGLE_LOGGING                         = 0x0C4,
    MSG_MOVE_TELEPORT                               = 0x860E,     // 1122  - 4.0.0.12319
    MSG_MOVE_TELEPORT_CHEAT                         = 0x0C6,
    MSG_MOVE_TELEPORT_ACK                           = 0x8674,    // 54874 - 4.0.0.12319
    MSG_MOVE_TOGGLE_FALL_LOGGING                    = 0x0C8,
    MSG_MOVE_FALL_LAND                              = 0x902C,    // 36968 - 4.0.0.12319
    MSG_MOVE_START_SWIM                             = 0x9644,    // 38468 - 4.0.0.12319
    MSG_MOVE_STOP_SWIM                              = 0x443E,    // 21008 - 4.0.0.12319
    MSG_MOVE_SET_RUN_SPEED_CHEAT                    = 0x0CC,
    MSG_MOVE_SET_RUN_SPEED                          = 0xD006,    // 53788 - 4.0.0.12319
    MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT               = 0x0CE,
    MSG_MOVE_SET_RUN_BACK_SPEED                     = 0x650,    // 18012 - 4.0.0.12319
    MSG_MOVE_SET_WALK_SPEED_CHEAT                   = 0x0D0,
    MSG_MOVE_SET_WALK_SPEED                         = 0x4012,    // 53886 - 4.0.0.12319
    MSG_MOVE_SET_SWIM_SPEED_CHEAT                   = 0x0D2,
    MSG_MOVE_SET_SWIM_SPEED                         = 0xC624,    // 20536 - 4.0.0.12319
    MSG_MOVE_SET_SWIM_BACK_SPEED_CHEAT              = 0x0D4,
    MSG_MOVE_SET_SWIM_BACK_SPEED                    = 0x4462,    // 54372 - 4.0.0.12319
    MSG_MOVE_SET_ALL_SPEED_CHEAT                    = 0x0D6,
    MSG_MOVE_SET_TURN_RATE_CHEAT                    = 0x0D7,
    MSG_MOVE_SET_TURN_RATE                          = 0x425E,    // 17486 - 4.0.0.12319
    MSG_MOVE_TOGGLE_COLLISION_CHEAT                 = 0x9068,     // 532   - 4.0.0.12319
    MSG_MOVE_SET_FACING                             = 0x9644,    // 36908 - 4.0.0.12319
    MSG_MOVE_SET_PITCH                              = 0x5210,    // 6     - 4.0.0.12319
    MSG_MOVE_WORLDPORT_ACK                          = 0xD20A,    // 53770 - 4.0.0.12319
    SMSG_MONSTER_MOVE                               = 0x566C,     // 1538  - 4.0.0.12319
    SMSG_MOVE_WATER_WALK                            = 0xC678,    // 50808 - 4.0.0.12319
    SMSG_MOVE_LAND_WALK                             = 0x9026,    // 20604 - 4.0.0.12319
    MSG_MOVE_SET_RAW_POSITION_ACK                   = 0x0E0,
    CMSG_MOVE_SET_RAW_POSITION                      = 0x900C,    // 36876 - 4.0.0.12319
    SMSG_FORCE_RUN_SPEED_CHANGE                     = 0x5250,    // 38466 - 4.0.0.12319
    CMSG_FORCE_RUN_SPEED_CHANGE_ACK                 = 0xD020,    // 53280 - 4.0.0.12319
    SMSG_FORCE_RUN_BACK_SPEED_CHANGE                = 0xD024,    // 37902 - 4.0.0.12319
    CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK            = 0x8624,    // 34340 - 4.0.0.12319
    SMSG_FORCE_SWIM_SPEED_CHANGE                    = 0x9408,    // 4204  - 4.0.0.12319
    CMSG_FORCE_SWIM_SPEED_CHANGE_ACK                = 0x046C,    // 1132  - 4.0.0.12319
    SMSG_FORCE_MOVE_ROOT                            = 0x924A,    // 4098  - 4.0.0.12319
    CMSG_FORCE_MOVE_ROOT_ACK                        = 0x445E,    // 17502 - 4.0.0.12319
    SMSG_FORCE_MOVE_UNROOT                          = 0x444E,    // 49234 - 4.0.0.12319
    CMSG_FORCE_MOVE_UNROOT_ACK                      = 0xC40A,    // 50186 - 4.0.0.12319
    MSG_MOVE_ROOT                                   = 0xD20A,    // 20508 - 4.0.0.12319
    MSG_MOVE_UNROOT                                 = 0x602,    // 38468 - 4.0.0.12319
    MSG_MOVE_HEARTBEAT                              = 0x1272,    // 34418 - 4.0.0.12319
    SMSG_MOVE_KNOCK_BACK                            = 0xC604,    // 17442 - 4.0.0.12319
    CMSG_MOVE_KNOCK_BACK_ACK                        = 0x8234,    // 33332 - 4.0.0.12319
    MSG_MOVE_KNOCK_BACK                             = 0xD674,    // 54290 - 4.0.0.12319
    SMSG_MOVE_FEATHER_FALL                          = 0x465C,    // 36886 - 4.0.0.12319
    SMSG_MOVE_NORMAL_FALL                           = 0x9642,     // 1654  - 4.0.0.12319
    SMSG_MOVE_SET_HOVER                             = 0xD020,    // 38516 - 4.0.0.12319
    SMSG_MOVE_UNSET_HOVER                           = 0x940E,    // 54856 - 4.0.0.12319
    CMSG_MOVE_HOVER_ACK                             = 0x041C,    // 1052  - 4.0.0.12319
    MSG_MOVE_HOVER                                  = 0x248,    // 32872 - 4.0.0.12319
    ...
    SMSG_INITIALIZE_FACTIONS                        = 0x5236,    // 20522 - 4.0.0.12319
    SMSG_SET_FACTION_VISIBLE                        = 0xD212,    // 32794 - 4.0.0.12319
    SMSG_SET_FACTION_STANDING                       = 0x9414,    // 37994 - 4.0.0.12319
    ...
    SMSG_CAST_FAILED                                = 0x8070,    // 53816 - 4.0.0.12319
    SMSG_SPELL_START                                = 0x903A,    // 50198 - 4.0.0.12319
    SMSG_SPELL_GO                                   = 0x502A,    // 54910 - 4.0.0.12319
    SMSG_SPELL_FAILURE                              = 0x801A,    // 17950 - 4.0.0.12319
    SMSG_SPELL_COOLDOWN                             = 0xC67C,    // 50812 - 4.0.0.12319
    SMSG_COOLDOWN_EVENT                             = 0x8478,    // 21066 - 4.0.0.12319
    CMSG_CANCEL_AURA                                = 0x0037,    // 55    - 4.0.0.12319
    SMSG_EQUIPMENT_SET_SAVED                        = 0x41E,    // 5120  - 4.0.0.12319
    SMSG_PET_CAST_FAILED                            = 0x8460,    // 17530 - 4.0.0.12319
    MSG_CHANNEL_START                               = 0x146E,    // 21576 - 4.0.0.12319
    MSG_CHANNEL_UPDATE                              = 0x9618,    // 34338 - 4.0.0.12319
    CMSG_CANCEL_CHANNELLING                         = 0x0244,    // 580   - 4.0.0.12479
    SMSG_AI_REACTION                                = 0x507C,    // 16952 - 4.0.0.12319
    ...
    SMSG_ATTACKSTART                                = 0x461E,    // 53832 - 4.0.0.12319
    SMSG_ATTACKSTOP                                 = 0x946A,    // 50188 - 4.0.0.12319
    SMSG_ATTACKSWING_NOTINRANGE                     = 0x524A,    // 21626 - 4.0.0.12319
    SMSG_ATTACKSWING_BADFACING                      = 0x8604,    // 21090 - 4.0.0.12319
    SMSG_INSTANCE_LOCK_WARNING_QUERY                = 0x424E,    // 16974 - 4.0.0.12319
    SMSG_ATTACKSWING_DEADTARGET                     = 0x447A,    // 53256 - 4.0.0.12319
    SMSG_ATTACKSWING_CANT_ATTACK                    = 0x5448,    // 33338 - 4.0.0.12319
    SMSG_ATTACKERSTATEUPDATE                        = 0x8622,    // 4670  - 4.0.0.12319
    SMSG_BATTLEFIELD_PORT_DENIED                    = 0xC47A,    // 54868 - 4.0.0.12319
    SMSG_DAMAGE_DONE_OBSOLETE                       = 0x14C,
    SMSG_UNIT_SPELLCAST_START                       = 0x8476,    // 4136  - 4.0.0.12319
    ...
    SMSG_BREAK_TARGET                               = 0xD228,    // 16436 - 4.0.0.12319
    ...
    SMSG_CLIENT_CONTROL_UPDATE                      = 0x866E,     // 598   - 4.0.0.12319
    ...
    SMSG_MOUNTSPECIAL_ANIM                          = 0x6E,    // 22052 - 4.0.0.12319
    SMSG_PET_TAME_FAILURE                           = 0x562C,    // 53808 - 4.0.0.12319
    ...
    SMSG_PET_SPELLS                                 = 0x501A,    // 49204 - 4.0.0.12319
    SMSG_PET_MODE                                   = 0x923A,    // 38514 - 4.0.0.12319
    CMSG_GOSSIP_HELLO                               = 0x8476,    // 33910 - 4.0.0.12319
    CMSG_GOSSIP_SELECT_OPTION                       = 0x5020,    // 20512 - 4.0.0.12319
    SMSG_GOSSIP_MESSAGE                             = 0xD424,    // 16916 - 4.0.0.12319
    SMSG_GOSSIP_COMPLETE                            = 0x863A,    // 34358 - 4.0.0.12319
    ...
    SMSG_QUERY_TIME_RESPONSE                        = 0xD04E,    // 4698  - 4.0.0.12319
    ...
    SMSG_ENCHANTMENTLOG                             = 0xD61A,    // 37940 - 4.0.0.12319
    ...
    SMSG_CLEAR_COOLDOWN                             = 0x4E,    // 21024 - 4.0.0.12319
    SMSG_GAMEOBJECT_PAGETEXT                        = 0x8436,    // 33846 - 4.0.0.12319
    CMSG_SETSHEATHED                                = 0x1E0,
    SMSG_COOLDOWN_CHEAT                             = 0x142E,    // 54864 - 4.0.0.12319
    SMSG_SPELL_DELAYED                              = 0x1000,    // 37384 - 4.0.0.12319
    ...
    SMSG_AUTH_RESPONSE                              = 0x5220,    // 21024 - 4.0.0.12479
    ...
    SMSG_PLAY_SPELL_VISUAL                          = 0x5674,    // 49698 - 4.0.0.12319
    CMSG_ZONEUPDATE                                 = 0x526E,    // 21102 - 4.0.0.12319
    SMSG_PARTYKILLLOG                               = 0xC030,    // 38408 - 4.0.0.12319
    SMSG_COMPRESSED_UPDATE_OBJECT                   = 0x1242,    // 4674  - 4.0.0.12479
    ...
    SMSG_ENVIRONMENTALDAMAGELOG                     = 0xC050,    // 4180  - 4.0.0.12319
    CMSG_PLAYER_DIFFICULTY_CHANGE                   = 0x1FD,
    SMSG_RWHOIS                                     = 0x9022,    // 36898 - 4.0.0.12319
    SMSG_LFG_PLAYER_REWARD                          = 0x5062,    // 50200 - 4.0.0.12319, uint32, uint8, uint32, uint32, uint32, uint32, uint32, uint8, for(uint8) {uint32,uint32,uint32}
    SMSG_LFG_TELEPORT_DENIED                        = 0x965A,    // 49226 - 4.0.0.12319, uint32 (1,2,4,6;0,5,7)
    ...
    SMSG_GMTICKET_CREATE                            = 0x9468,    // 21554 - 4.0.0.12319
    CMSG_GMTICKET_UPDATETEXT                        = 0x207,
    SMSG_GMTICKET_UPDATETEXT                        = 0x961A,    // 21508 - 4.0.0.12319
    ...
    SMSG_GMTICKET_GETTICKET                         = 0x5048,    // 21612 - 4.0.0.12319
    CMSG_UNLEARN_TALENTS                            = 0x213,
    SMSG_GAMEOBJECT_SPAWN_ANIM_OBSOLETE             = 0x8200,    // 37452 - 4.0.0.12319
    SMSG_GAMEOBJECT_DESPAWN_ANIM                    = 0x460C,    // 17932 - 4.0.0.12319
    MSG_CORPSE_QUERY                                = 0x5432,    // 20526 - 4.0.0.12319
    CMSG_GMTICKET_DELETETICKET                      = 0x217,
    SMSG_GMTICKET_DELETETICKET                      = 0x5404,    // 32854 - 4.0.0.12319
    ...
    SMSG_GOSSIP_POI                                 = 0x924C,    // 5220  - 4.0.0.12319
    ...
    SMSG_SEND_MAIL_RESULT                           = 0xC036,    // 26    - 4.0.0.12319
    CMSG_GET_MAIL_LIST                              = 0xD262,    // 53858 - 4.0.0.12319
    SMSG_MAIL_LIST_RESULT                           = 0x961C,    // 21028 - 4.0.0.12319
    CMSG_BATTLEFIELD_LIST                           = 0x9620,    // 38432 - 4.0.0.12319
    SMSG_BATTLEFIELD_LIST                           = 0x5646,    // 5752  - 4.0.0.12319
    CMSG_BATTLEFIELD_JOIN                           = 0x4632,    // 17970 - 4.0.0.12319
    SMSG_BATTLEFIELD_WIN_OBSOLETE                   = 0x8270,    // 53276 - 4.0.0.12319
    ...
    SMSG_PERIODICAURALOG                            = 0x127A,    // 4124  - 4.0.0.12319
    ...
    SMSG_PROCRESIST                                 = 0x1466,    // 34402 - 4.0.0.12319
    SMSG_STANDSTATE_CHANGE_FAILURE_OBSOLETE         = 0xD028,    // 37428 - 4.0.0.12319
    SMSG_DISPEL_FAILED                              = 0x565C,    // 37392 - 4.0.0.12319
    ...
    SMSG_SET_FLAT_SPELL_MODIFIER                    = 0x7A,    // 20554 - 4.0.0.12319
    SMSG_SET_PCT_SPELL_MODIFIER                     = 0x926A,    // 18034 - 4.0.0.12319
    CMSG_SET_AMMO                                   = 0x268,
    ...
    MSG_LIST_STABLED_PETS                           = 0xC60C,    // 53874 - 4.0.0.12319
    CMSG_STABLE_PET                                 = 0x270,
    CMSG_UNSTABLE_PET                               = 0x271,
    CMSG_BUY_STABLE_SLOT                            = 0x272,
    SMSG_STABLE_RESULT                              = 0x4032,    // 17920 - 4.0.0.12319
    ...
    MSG_QUERY_NEXT_MAIL_TIME                        = 0xC452,    // 20538 - 4.0.0.12319
    SMSG_RECEIVED_MAIL                              = 0x5264,    // 17968 - 4.0.0.12319
    ...
    SMSG_LFG_OFFER_CONTINUE                         = 0x8462,    // 54840 - 4.0.0.12319
    ...
    SMSG_MEETINGSTONE_COMPLETE                      = 0x9600,    // 5198  - 4.0.0.12319, mail open from gossip?, EVENT_MAIL_SHOW
    ...
    SMSG_CANCEL_AUTO_REPEAT                         = 0xC470,    // 16936 - 4.0.0.12319
    SMSG_STANDSTATE_UPDATE                          = 0x964A,     // 1096  - 4.0.0.12319
    ...
    SMSG_SET_FORCED_REACTIONS                       = 0x925A,    // 5674  - 4.0.0.12319
    SMSG_SPELL_FAILED_OTHER                         = 0x463C,    // 21594 - 4.0.0.12319
    SMSG_GAMEOBJECT_RESET_STATE                     = 0x144E,    // 18028 - 4.0.0.12319
    ...
    SMSG_MONSTER_MOVE_TRANSPORT                     = 0xD21C,    // 38506 - 4.0.0.12319
    SMSG_PET_BROKEN                                 = 0x5022,    // 16460 - 4.0.0.12319
    MSG_MOVE_FEATHER_FALL                           = 0x466A,    // 21044 - 4.0.0.12319
    MSG_MOVE_WATER_WALK                             = 0x900C,     // 1606  - 4.0.0.12319
    CMSG_SERVER_BROADCAST                           = 0x2B2,
    CMSG_SELF_RES                                   = 0x2B3,
    SMSG_FEIGN_DEATH_RESISTED                       = 0xD25E,     // 1060  - 4.0.0.12319
    ...
    SMSG_LFG_ROLE_CHOSEN                            = 0xD404,    // 20500 - 4.0.0.12319
	...
	SMSG_INIT_WORLD_STATES                          = 0xC014,    // 33798 - 4.0.0.12319
    ...
    SMSG_PET_ACTION_FEEDBACK                        = 0x4242,    // 20584 - 4.0.0.12319
    CMSG_CHAR_RENAME                                = 0x2C7,
    SMSG_CHAR_RENAME                                = 0x120A,    // 33296 - 4.0.0.12319
    ...
    SMSG_GROUP_JOINED_BATTLEGROUND                  = 0x4258,    // 53764 - 4.0.0.12319
    MSG_BATTLEGROUND_PLAYER_POSITIONS               = 0x28,    // 54796 - 4.0.0.12319
    CMSG_PET_STOP_ATTACK                            = 0x2EA,
    SMSG_BINDER_CONFIRM                             = 0x162E,    // 5678  - 4.0.0.12319
    SMSG_BATTLEGROUND_PLAYER_JOINED                 = 0x8458,    // 34396 - 4.0.0.12319
    SMSG_BATTLEGROUND_PLAYER_LEFT                   = 0x103C,    // 16466 - 4.0.0.12319
    CMSG_BATTLEMASTER_JOIN                          = 0x2EE,
    SMSG_ADDON_INFO                                 = 0x4022,    // 16418 - 4.0.0.12479
    ...
    SMSG_MINIGAME_SETUP                             = 0x1026,    // 54880 - 4.0.0.12319
    SMSG_MINIGAME_STATE                             = 0x612,    // 21100 - 4.0.0.12319
    ...
    SMSG_COMPRESSED_MOVES                           = 0x162E,    // 5678  - 4.0.0.12479
    CMSG_GUILD_INFO_TEXT                            = 0x2FC,
    SMSG_CHAT_RESTRICTED                            = 0x8034,    // 32820 - 4.0.0.12319
    SMSG_SPLINE_SET_RUN_SPEED                       = 0x106A,    // 36890 - 4.0.0.12319
    SMSG_SPLINE_SET_RUN_BACK_SPEED                  = 0x8034,     // 1648  - 4.0.0.12319
    SMSG_SPLINE_SET_SWIM_SPEED                      = 0x901A,    // 32800 - 4.0.0.12319
    SMSG_SPLINE_SET_WALK_SPEED                      = 0xD074,    // 54860 - 4.0.0.12319
    SMSG_SPLINE_SET_SWIM_BACK_SPEED                 = 0x403E,    // 5644  - 4.0.0.12319
    SMSG_SPLINE_SET_TURN_RATE                       = 0x462A,    // 49262 - 4.0.0.12319
    SMSG_SPLINE_MOVE_UNROOT                         = 0x5418,    // 53370 - 4.0.0.12319
    SMSG_SPLINE_MOVE_FEATHER_FALL                   = 0x5000,    // 50234 - 4.0.0.12319
    SMSG_SPLINE_MOVE_NORMAL_FALL                    = 0x527A,    // 33352 - 4.0.0.12319
    SMSG_SPLINE_MOVE_SET_HOVER                      = 0x446A,    // 16976 - 4.0.0.12319
    SMSG_SPLINE_MOVE_UNSET_HOVER                    = 0x238,    // 5126  - 4.0.0.12319
    SMSG_SPLINE_MOVE_WATER_WALK                     = 0x1640,    // 22124 - 4.0.0.12319
    SMSG_SPLINE_MOVE_LAND_WALK                      = 0x668,     // 1640  - 4.0.0.12319
    SMSG_SPLINE_MOVE_START_SWIM                     = 0xD660,    // 34372 - 4.0.0.12319
    SMSG_SPLINE_MOVE_STOP_SWIM                      = 0x526C,    // 49242 - 4.0.0.12319
    SMSG_SPLINE_MOVE_SET_RUN_MODE                   = 0x802C,    // 54320 - 4.0.0.12319
    SMSG_SPLINE_MOVE_SET_WALK_MODE                  = 0x67A,    // 5688  - 4.0.0.12319
    ...
    SMSG_SET_FACTION_ATWAR                          = 0xC06E,    // 21080 - 4.0.0.12319
    ...
    MSG_MOVE_TIME_SKIPPED                           = 0x927C,    // 22020 - 4.0.0.12319
    SMSG_SPLINE_MOVE_ROOT                           = 0x7C,    // 33850 - 4.0.0.12319
    ...
    SMSG_PET_ACTION_SOUND                           = 0x46C,    // 36864 - 4.0.0.12319
    SMSG_PET_DISMISS_SOUND                          = 0x920C,    // 37928 - 4.0.0.12319
    SMSG_GHOSTEE_GONE                               = 0x326,
    CMSG_GM_UPDATE_TICKET_STATUS                    = 0x327,
    SMSG_GM_TICKET_STATUS_UPDATE                    = 0x1634,    // 22088 - 4.0.0.12319
    MSG_SET_DUNGEON_DIFFICULTY                      = 0x5604,    // 22130 - 4.0.0.12319
    ...
    SMSG_SPELL_UPDATE_CHAIN_TARGETS                 = 0xC04C,     // 1082  - 4.0.0.12319
    ...
    SMSG_MOTD                                       = 0xD432,    // 21016 - 4.0.0.12319
    SMSG_MOVE_SET_FLIGHT                            = 0xC426,    // 34392 - 4.0.0.12319
    SMSG_MOVE_UNSET_FLIGHT                          = 0xC602,    // 21076 - 4.0.0.12319
    CMSG_MOVE_FLIGHT_ACK                            = 0x9666,    // 38502 - 4.0.0.12319
    MSG_MOVE_START_SWIM_CHEAT                       = 0x4432,     // 1548  - 4.0.0.12319
    MSG_MOVE_STOP_SWIM_CHEAT                        = 0x9654,    // 37986 - 4.0.0.12319
    SMSG_MOVE_SET_CAN_FLY                           = 0x66,    // 54844 - 4.0.0.12319
    SMSG_MOVE_UNSET_CAN_FLY                         = 0x9062,    // 22054 - 4.0.0.12319
    ...
    UMSG_UPDATE_ARENA_TEAM_OBSOLETE                 = 0xD278,    // 37464 - 4.0.0.12319
    CMSG_ARENA_TEAM_QUERY                           = 0x616,    // 49778 - 4.0.0.12479
    ...
    MSG_MOVE_START_ASCEND                           = 0x864C,    // 36956 - 4.0.0.12319
    MSG_MOVE_STOP_ASCEND                            = 0x9258,    // 4692  - 4.0.0.12319
    SMSG_ARENA_TEAM_STATS                           = 0x5276,    // 36924 - 4.0.0.12319
    ...
    SMSG_UPDATE_LFG_LIST                            = 0x5E,    // 34356 - 4.0.0.12319, SMSG uint32, uint32, if(uint8) { uint32 count, for(count) { uint64} }, uint32 count2, uint32, for(count2) { uint64, uint32 flags, if(flags & 0x2) {string}, if(flags & 0x10) {for(3) uint8}, if(flags & 0x80) {uint64, uint32}}, uint32 count3, uint32, for(count3) {uint64, uint32 flags, if(flags & 0x1) {uint8, uint8, uint8, for(3) uint8, uint32, uint32, uint32, uint32, uint32, uint32, float, float, uint32, uint32, uint32, uint32, uint32, float, uint32, uint32, uint32, uint32, uint32, uint32}, if(flags&0x2) string, if(flags&0x4) uint8, if(flags&0x8) uint64, if(flags&0x10) uint8, if(flags&0x20) uint32, if(flags&0x40) uint8, if(flags& 0x80) {uint64, uint32}}
    SMSG_LFG_PROPOSAL_UPDATE                        = 0xD07C,    // 21630 - 4.0.0.12319, SMSG uint32, uint8, uint32, uint32, uint8, for(uint8) {uint32,uint8,uint8,uint8,uint8}
    CMSG_LFG_PROPOSAL_RESULT                        = 0x362,     // CMSG AcceptProposal, RejectProposal
    SMSG_LFG_ROLE_CHECK_UPDATE                      = 0x507E,    // 49672 - 4.0.0.12319, SMSG uint32, uint8, for(uint8) uint32, uint8, for(uint8) { uint64, uint8, uint32, uint8, }
    SMSG_LFG_JOIN_RESULT                            = 0x656,    // 32782 - 4.0.0.12319, SMSG uint32 unk, uint32, if(unk==6) { uint8 count, for(count) uint64 }
    SMSG_LFG_QUEUE_STATUS                           = 0x1010,    // 32772 - 4.0.0.12319, SMSG uint32 dungeon, uint32 lfgtype, uint32, uint32, uint32, uint32, uint8, uint8, uint8, uint8
    CMSG_SET_LFG_COMMENT                            = 0x366,     // CMSG SetLFGComment
    SMSG_LFG_UPDATE_PLAYER                          = 0x4222,    // 16472 - 4.0.0.12319, SMSG uint8, if(uint8) { uint8, uint8, uint8, uint8, if(uint8) for(uint8) uint32, string}
    SMSG_LFG_UPDATE_PARTY                           = 0x9442,    // 37476 - 4.0.0.12319, SMSG uint8, if(uint8) { uint8, uint8, uint8, for(3) uint8, uint8, if(uint8) for(uint8) uint32, string}
    SMSG_LFG_UPDATE_SEARCH                          = 0x905C,    // 49270 - 4.0.0.12319, SMSG uint8
    ...
    SMSG_LFG_BOOT_PLAYER                            = 0xD20C,    // 20534 - 4.0.0.12319, SMSG uint8, uint8, uint8, uint64, uint32, uint32, uint32, uint32
    CMSG_LFD_PLAYER_LOCK_INFO_REQUEST               = 0x8440,    // 33856 - 4.0.0.12319, CMSG RequestLFDPlayerLockInfo
    SMSG_LFG_PLAYER_INFO                            = 0x862A,    // 32866 - 4.0.0.12319,  SMSG uint8, for(uint8) { uint32, uint8, uint32, uint32, uint32, uint32, uint8, for(uint8) {uint32,uint32, uint32}}, uint32, for(uint32) {uint32,uint32}
    ...
    SMSG_LFG_PARTY_INFO                             = 0x523A,    // 54854 - 4.0.0.12319, SMSG uint8, for(uint8) uint64
    ...
    MSG_INSPECT_ARENA_TEAMS                         = 0x4058,    // 1652  - 4.0.0.12319
    ...
    MSG_MOVE_SET_FLIGHT_SPEED                       = 0x462,    // 50178 - 4.0.0.12319
    MSG_MOVE_SET_FLIGHT_BACK_SPEED_CHEAT            = 0x37F,
    MSG_MOVE_SET_FLIGHT_BACK_SPEED                  = 0x8440,    // 21580 - 4.0.0.12319
    SMSG_FORCE_FLIGHT_SPEED_CHANGE                  = 0x4072,    // 38512 - 4.0.0.12319
    CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK              = 0x847E,    // 33918 - 4.0.0.12319
    SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE             = 0x126C,    // 4678  - 4.0.0.12319
    CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK         = 0x8060,    // 32864 - 4.0.0.12319
    SMSG_SPLINE_SET_FLIGHT_SPEED                    = 0x101A,     // 544   - 4.0.0.12319
    SMSG_SPLINE_SET_FLIGHT_BACK_SPEED               = 0x4632,    // 38478 - 4.0.0.12319
    ...
    SMSG_LFG_DISABLED                               = 0x274,    // 33852 - 4.0.0.12319
    ...
    MSG_MOVE_START_DESCEND                          = 0xD67A,    // 37888 - 4.0.0.12319
    ...
    SMSG_DISMOUNT                                   = 0x8426,    // 33866 - 4.0.0.12319
    MSG_MOVE_UPDATE_CAN_FLY                         = 0x8272,    // 36930 - 4.0.0.12319
    ...
    SMSG_CLEAR_TARGET                               = 0x5030,     // 1596  - 4.0.0.12319
    ...
    CMSG_GM_CHARACTER_RESTORE                       = 0x1428,
    CMSG_GM_CHARACTER_SAVE                          = 0x3FB,
    SMSG_VOICESESSION_FULL                          = 0x2F6F,    // 12143 - 4.0.0.12065
    MSG_GUILD_PERMISSIONS                           = 0x546A,    // 53796 - 4.0.0.12319
    ...
    SMSG_FORCE_DISPLAY_UPDATE                       = 0x962C,    // 38444 - 4.0.0.12479
    ...
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT           = 0xC03C,    // 33398 - 4.0.0.12319
    ...
    SMSG_SPLINE_MOVE_UNSET_FLYING                   = 0xD240,    // 32804 - 4.0.0.12319
    SMSG_SUMMON_CANCEL                              = 0x9418,    // 37912 - 4.0.0.12319
    CMSG_CHANGE_PERSONAL_ARENA_RATING               = 0x425,
    CMSG_ALTER_APPEARANCE                           = 0x426,
    SMSG_ENABLE_BARBER_SHOP                         = 0xD66A,    // 54358 - 4.0.0.12319
    SMSG_BARBER_SHOP_RESULT                         = 0x864A,    // 32874 - 4.0.0.12319
    ...
    SMSG_NOTIFY_DANCE                               = 0x27E,    // 634   - 4.0.0.12319
    CMSG_PLAY_DANCE                                 = 0x44B,
    SMSG_PLAY_DANCE                                 = 0x4018,    // 21610 - 4.0.0.12319
    CMSG_LOAD_DANCES                                = 0x44D,
    CMSG_STOP_DANCE                                 = 0x540C,    // 21516 - 4.0.0.12319
    SMSG_STOP_DANCE                                 = 0xC24E,    // 54784 - 4.0.0.12319
    ...
    SMSG_LEARNED_DANCE_MOVES                        = 0x560C,    // 53786 - 4.0.0.12319
    ...
    SMSG_FORCE_PITCH_RATE_CHANGE                    = 0x125C,    // 50706 - 4.0.0.12319
    CMSG_FORCE_PITCH_RATE_CHANGE_ACK                = 0xD00A,    // 53258 - 4.0.0.12319
    SMSG_SPLINE_SET_PITCH_RATE                      = 0x1212,    // 20580 - 4.0.0.12319
    ...
    SMSG_ACHIEVEMENT_EARNED                         = 0x4024,    // 53812 - 4.0.0.12319
    SMSG_DYNAMIC_DROP_ROLL_RESULT                   = 0x469,
    SMSG_CRITERIA_UPDATE                            = 0xD604,    // 33908 - 4.0.0.12319
    ...
    SMSG_CHAR_CUSTOMIZE                             = 0xD00A,    // 54370 - 4.0.0.12319
    SMSG_PET_RENAMEABLE                             = 0x5064,    // 38486 - 4.0.0.12319
    ...
    SMSG_HEALTH_UPDATE                              = 0xD234,    // 53812 - 4.0.0.12479
    ...
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST                 = 0x445C,    // 22110 - 4.0.0.12319
    CMSG_AUCTION_LIST_PENDING_SALES                 = 0x48F,
    SMSG_AUCTION_LIST_PENDING_SALES                 = 0x9044,    // 36932 - 4.0.0.12319
    SMSG_MODIFY_COOLDOWN                            = 0xC412,    // 17456 - 4.0.0.12319
    SMSG_PET_UPDATE_COMBO_POINTS                    = 0x8010,    // 50220 - 4.0.0.12319
    CMSG_ENABLETAXI                                 = 0xC062,    // 49250 - 4.0.0.12319
    SMSG_PRE_RESURRECT                              = 0x120E,    // 4622  - 4.0.0.12319
    SMSG_AURA_UPDATE_ALL                            = 0x9648,     // 1626  - 4.0.0.12319
    ...
    SMSG_PET_LEARNED_SPELL                          = 0x902A,    // 20540 - 4.0.0.12319
    SMSG_PET_REMOVED_SPELL                          = 0xD068,    // 22070 - 4.0.0.12319
    CMSG_CHANGE_SEATS_ON_CONTROLLED_VEHICLE         = 0x9644,    // 38468 - 4.0.0.12319
    CMSG_HEARTH_AND_RESURRECT                       = 0x49C,     // not changed in 3.1
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA       = 0x4210,    // 34310 - 4.0.0.12319
    SMSG_CRITERIA_DELETED                           = 0x8246,    // 33868 - 4.0.0.12319
    ...
    SMSG_PET_GUIDS                                  = 0xC062,    // 36958 - 4.0.0.12319, shifted+5
    SMSG_CLIENTCACHE_VERSION                        = 0x120E,    // 4622  - 4.0.0.12479, shifted+5
    ...
    SMSG_CORPSE_MAP_POSITION_QUERY_RESPONSE         = 0xC22A,    // 5686  - 4.0.0.12319, SMSG, 3*float+float
    ...
    SMSG_EQUIPMENT_SET_LIST                         = 0x63E,    // 20480 - 4.0.0.12319, SMSG, equipment manager list?
	...
	SMSG_SET_PROJECTILE_POSITION                    = 0x9460,    // 22096 - 4.0.0.12319, SMSG, uint64 caster, uint8 castId, vector3 position
    ...
    SMSG_ARENA_OPPONENT_UPDATE                      = 0xC02A,    // 16390 - 4.0.0.12319, uint64, EVENT_ARENA_OPPONENT_UPDATE
    ...
    SMSG_FORCE_UNK1_SPEED_CHANGE                    = 0x8624,    // 4734  - 4.0.0.12319, SMSG, movement related
    CMSG_FORCE_UNK1_SPEED_CHANGE_ACK                = 0x107A,    // 4218  - 4.0.0.12319, movement related
    SMSG_FORCE_UNK2_SPEED_CHANGE                    = 0x1636,    // 5642  - 4.0.0.12319, SMSG, movement related
    CMSG_FORCE_UNK2_SPEED_CHANGE_ACK                = 0x5470,    // 21616 - 4.0.0.12319, movement related
    MSG_MOVE_UNKNOWN_1234                           = 0x8438,     // 1084  - 4.0.0.12319, SMSG, movement related
    SMSG_SPLINE_MOVE_UNKNOWN_1235                   = 0xD214,    // 32868 - 4.0.0.12319, SMSG, movement related
    SMSG_SPLINE_MOVE_UNKNOWN_1236                   = 0x8072,     // 1608  - 4.0.0.12319, SMSG, movement related
    CMSG_EQUIPMENT_SET_USE                          = 0x19EC,    // 6636  - 4.0.0.12065, CMSG, lua: UseEquipmentSet
    SMSG_EQUIPMENT_SET_USE_RESULT                   = 0x5650,    // 49718 - 4.0.0.12319, SMSG, UseEquipmentSetResult?
    ...
    SMSG_CHAR_FACTION_CHANGE                        = 0x8238,    // 53814 - 4.0.0.12319, response to 1241 (PFC server response)
    UMSG_UNKNOWN_1243                               = 0x4DB,     // not found 3.2
    UMSG_UNKNOWN_1244                               = 0x4DC,     // not found 3.2
    UMSG_UNKNOWN_1245                               = 0x4DD,     // not found 3.2
    SMSG_BATTLEFIELD_MGR_ENTRY_INVITE               = 0x4006,     // 618   - 4.0.0.12319, uint32, EVENT_BATTLEFIELD_MGR_ENTRY_INVITE
    CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE      = 0x4DF,     // lua: BattlefieldMgrEntryInviteResponse
    SMSG_BATTLEFIELD_MGR_ENTERED                    = 0x9010,     // 602   - 4.0.0.12319, uint32, uint8, uint8 EVENT_BATTLEFIELD_MGR_ENTERED
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE               = 0x26E,    // 21572 - 4.0.0.12319, uint32 EVENT_BATTLEFIELD_MGR_QUEUE_INVITE
    ...
    SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE     = 0xC62A,    // 5758  - 4.0.0.12319, uint32, uint8 EVENT_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE
    SMSG_BATTLEFIELD_MGR_EJECT_PENDING              = 0x127E,    // 50790 - 4.0.0.12319, uint32 EVENT_BATTLEFIELD_MGR_EJECT_PENDING
    SMSG_BATTLEFIELD_MGR_EJECTED                    = 0x107A,      // 52    - 4.0.0.12319, uint32, uint32, uint8 EVENT_BATTLEFIELD_MGR_EJECTED
    CMSG_BATTLEFIELD_MGR_EXIT_REQUEST               = 0x4E7,     // lua: BattlefieldMgrExitRequest
    SMSG_BATTLEFIELD_MGR_STATE_CHANGE               = 0x5470,     // 1568  - 4.0.0.12319, uint32, uint32 EVENT_BATTLEFIELD_MGR_STATE_CHANGE
    ...
    SMSG_GMRESPONSE_DB_ERROR                        = 0xD246,    // 21534 - 4.0.0.12319, empty
    SMSG_GMRESPONSE_RECEIVED                        = 0x9078,    // 36884 - 4.0.0.12319, uint32, uint32, string[2000], string[4000][4]
    CMSG_GMRESPONSE_RESOLVE                         = 0x4F0,     // lua: GMResponseResolve
    SMSG_GMRESPONSE_STATUS_UPDATE                   = 0xD236,    // 50196 - 4.0.0.12319, uint8 (1 - EVENT_GMSURVEY_DISPLAY, 0 - EVENT_UPDATE_TICKET)
    ...
    SMSG_QUERY_QUESTS_COMPLETED_RESPONSE            = 0x940A,    // 17990 - 4.0.0.12319, response to CMSG_QUERY_QUESTS_COMPLETED
    ...
    SMSG_LFG_OPEN_FROM_GOSSIP                       = 0x9204,    // 32828 - 4.0.0.12319, event EVENT_LFG_OPEN_FROM_GOSSIP (opens dungeon finder, probably for outdoor bosses)
    SMSG_UNKNOWN_1302                               = 0x1220,    // 53818 - 4.0.0.12319, something with player movement (move event 58?)
    CMSG_UNKNOWN_1303                               = 0x446A,    // 17514 - 4.0.0.12319, something with player movement (move event 58?)
    SMSG_UNKNOWN_1304                               = 0x4646,    // 50292 - 4.0.0.12319, something with player movement (move event 58?), speed packet
    ...
    SMSG_UNKNOWN_1329                               = 0xC654,    // 5632  - 4.0.0.12319, faction related
