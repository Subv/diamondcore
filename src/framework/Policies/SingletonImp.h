...
>
T& Diamond::Singleton<T, ThreadingModel, CreatePolicy, LifeTimePolicy>::Instance()
{
    if (!si_instance)
    {
...
class LifeTimePolicy
>
void Diamond::Singleton<T, ThreadingModel, CreatePolicy, LifeTimePolicy>::DestroySingleton()
{
